...
```{r}
sendSweetAlert(session, title = "Thank you so much for choosing us as the winners!", text = "We are so overwhelmed by the result. Simply amazing that we convinced the jury at the end of this incredible challenging and educational experience over the past few months.", type = "success", btn_labels = "Congratulations!")
```
