...
```{r}
sendSweetAlert(session, title = "Thank you very much for making us the winners!", text = "We are so we are so overwhelmed by the result. Simply amazing that we convinced the jury in the end of this incredible, challenging and educative experience in the last months.", type = "success", btn_labels = "Congratulations!")
```
